  ...
  ***************************************************************************/
  onConnect: function(session, socket) {
    ...
    socket.on('newuser', function(msg){
      socket.set('username',msg.name);
      console.log(msg.name);
    //sails.sockets.emit('chatm',msg);
    });
    ...
    socket.on('chat', function(msg){
      ...
      console.info(data);
      sails.sockets.blast('chatm',data);
    //sails.sockets.emit('chatm',msg);
    });
    ...
    socket.on('register',function(data){
      console.log(data);
      if(players[data.invite]){
            if(players[data.invite].status=='empty') {
                players[data.invite].status = 'filled';
                players[data.invite].ids = 'socket.id';
                comptetors[players[data.invite].idf] = socket.id;
                comptetors[socket.id] = players[data.invite].idf;
    ...
    socket.on('turn',function(msg) {
        ...
        sails.sockets.emit(comptetors[socket.id],'newturn',msg);
